...
type GatewayConfigInformer interface {
	...
	Lister() apiv1beta1.GatewayConfigLister
}
	...
	return cache.NewSharedIndexInformer(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AigatewayV1beta1().GatewayConfigs(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AigatewayV1beta1().GatewayConfigs(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AigatewayV1beta1().GatewayConfigs(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AigatewayV1beta1().GatewayConfigs(namespace).Watch(ctx, options)
			},
		}, client),
		&aigatewayapiv1beta1.GatewayConfig{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *gatewayConfigInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&aigatewayapiv1beta1.GatewayConfig{}, f.defaultInformer)
}

func (f *gatewayConfigInformer) Lister() apiv1beta1.GatewayConfigLister {
	return apiv1beta1.NewGatewayConfigLister(f.Informer().GetIndexer())
}
