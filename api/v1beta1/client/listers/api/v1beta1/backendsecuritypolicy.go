...
type BackendSecurityPolicyLister interface {
	...
	List(selector labels.Selector) (ret []*apiv1beta1.BackendSecurityPolicy, err error)
...
type backendSecurityPolicyLister struct {
	listers.ResourceIndexer[*apiv1beta1.BackendSecurityPolicy]
}
...
func NewBackendSecurityPolicyLister(indexer cache.Indexer) BackendSecurityPolicyLister {
	return &backendSecurityPolicyLister{listers.New[*apiv1beta1.BackendSecurityPolicy](indexer, apiv1beta1.Resource("backendsecuritypolicy"))}
}

// BackendSecurityPolicies returns an object that can list and get BackendSecurityPolicies.
func (s *backendSecurityPolicyLister) BackendSecurityPolicies(namespace string) BackendSecurityPolicyNamespaceLister {
	return backendSecurityPolicyNamespaceLister{listers.NewNamespaced[*apiv1beta1.BackendSecurityPolicy](s.ResourceIndexer, namespace)}
}
...
type BackendSecurityPolicyNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*apiv1beta1.BackendSecurityPolicy, error)
