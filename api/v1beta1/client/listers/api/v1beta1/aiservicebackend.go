...
type AIServiceBackendLister interface {
	...
	List(selector labels.Selector) (ret []*apiv1beta1.AIServiceBackend, err error)
...
type aIServiceBackendLister struct {
	listers.ResourceIndexer[*apiv1beta1.AIServiceBackend]
}
...
func NewAIServiceBackendLister(indexer cache.Indexer) AIServiceBackendLister {
	return &aIServiceBackendLister{listers.New[*apiv1beta1.AIServiceBackend](indexer, apiv1beta1.Resource("aiservicebackend"))}
}

// AIServiceBackends returns an object that can list and get AIServiceBackends.
func (s *aIServiceBackendLister) AIServiceBackends(namespace string) AIServiceBackendNamespaceLister {
	return aIServiceBackendNamespaceLister{listers.NewNamespaced[*apiv1beta1.AIServiceBackend](s.ResourceIndexer, namespace)}
}
...
type AIServiceBackendNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*apiv1beta1.AIServiceBackend, error)
