...
const (
	...
	// BackendNameHeaderKey is the internal header key used to carry selected backend
	// context for translation and file ID routing metadata.
...
const (
	...
	// AIGatewaySelectedBackndMetadataKey stores the selected backend identifier in
	// AI Gateway dynamic metadata for sticky route matching.
